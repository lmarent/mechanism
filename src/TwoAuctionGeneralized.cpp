...
void executeAuctionRandomAllocation(auction::fieldDefList_t *fieldDefs, auction::fieldValList_t *fieldVals, double price,
					string aset, string aname, time_t start, time_t stop, LAuctionRequestDB_t &bidsToFulfil, double qtyAvailable, 
